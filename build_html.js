    ...
    <div id="tab-distribution" class="tab-panel">
      ...
      <div class="glass-card" style="margin-bottom: 2rem; border-left: 4px solid var(--blue);">
        ...
        <table class="matrix-table">
          ...
          <tbody>
            <tr><td><b>Class 2</b></td><td>Junior Mechatronics Linkages</td><td><span class="box-badge yellow" onclick="showBoxModal('boxA')">📦 Box A (Structural)</span></td><td class="muted">None.</td></tr>
            <tr><td><b>Class 3</b></td><td>Block Coding & 3D Drafting</td><td><span class="box-badge yellow" onclick="showBoxModal('boxA')">📦 Box A (Structural)</span></td><td class="muted">3D Pen + PLA filaments.</td></tr>
            <tr><td><b>Class 4</b></td><td>Scratch Level 2 & Circuit Laws</td><td><span class="box-badge blue" onclick="showBoxModal('boxB')">📦 Box B (Basic Electronics)</span></td><td class="muted">Multimeter.</td></tr>
            <tr><td><b>Class 5</b></td><td>AI Principles & Active Circuits</td><td><span class="box-badge blue" onclick="showBoxModal('boxB')">📦 Box B (Basic Electronics)</span></td><td class="muted">ESP32 + webcam.</td></tr>
            <tr><td><b>Class 6</b></td><td>Embedded C++ & Web Basics</td><td><span class="box-badge blue" onclick="showBoxModal('boxB')">📦 Box B</span> + <span class="box-badge green" onclick="showBoxModal('boxC')">📦 Box C</span></td><td class="muted">Base (Box B) + Sensors (Box C).</td></tr>
            <tr><td><b>Class 7</b></td><td>Smart IoT & Ranging Sensors</td><td><span class="box-badge green" onclick="showBoxModal('boxC')">📦 Box C (Sensors & IoT)</span></td><td class="muted">NodeMCU programmer modules.</td></tr>
            <tr><td><b>Class 8</b></td><td>Precision Robotics & AI NLP</td><td><span class="box-badge blue" onclick="showBoxModal('boxB')">📦 Box B</span> + <span class="box-badge green" onclick="showBoxModal('boxC')">📦 Box C</span></td><td class="muted">ESP32 (Vault) + Drivers (Box B) + Sensors (Box C).</td></tr>
            <tr><td><b>Class 9</b></td><td>Python & Additive Slicing</td><td><span class="box-badge blue" onclick="showBoxModal('boxB')">📦 Box B</span> + <span class="box-badge green" onclick="showBoxModal('boxC')">📦 Box C</span></td><td class="muted">Bambu Lab P1S 3D Printer.</td></tr>
            <tr><td><b>Class 10</b></td><td>Edge AI & Computer Vision</td><td><span class="box-badge green" onclick="showBoxModal('boxC')">📦 Box C (Sensors & IoT)</span></td><td class="muted">ESP32-CAM + Programmer.</td></tr>
            <tr><td><b>Class 11</b></td><td>Avionics & Autonomous Drones</td><td><span class="box-badge red" onclick="showBoxModal('boxD')">📦 Box D (Drone Assembly)</span></td><td class="muted">3S LiPo + Radio controller.</td></tr>
      ...
      <div class="glass-card" style="border-left: 4px solid var(--green);">
        ...
        <div style="background: rgba(16,185,129,0.1); border: 1px solid rgba(16,185,129,0.2); padding: 1rem; border-radius: 12px; margin-bottom: 1.5rem;">
          ...
          <ul style="font-size:0.85rem; color:#fff; margin-left: 1.5rem;">
            <li>1x Arduino Uno R3 + 1x Solderless Breadboard (830 pin)</li>
            <li>2x BO Gear Motors + 2x Wheels + 1x Motor Driver (L298N)</li>
            <li>Jumper Wires, LEDs, and Resistors Pack</li>
          </ul>
        </div>
        ...
        <table class="matrix-table">
          ...
          <tbody>
            <tr><td><b>Class 2 & 3</b></td><td>Mechatronics & 3D</td><td><span class="box-badge yellow" onclick="showBoxModal('boxA')">📦 Box A</span></td><td class="muted">Standard setup.</td></tr>
            <tr><td><b>Class 4 & 5</b></td><td>Basic Electronics</td><td><span class="box-badge blue" onclick="showBoxModal('boxB')">📦 Box B</span></td><td class="muted">Standard setup.</td></tr>
            <tr><td><b>Class 6</b></td><td>Embedded C++ & Web</td><td><span class="box-badge green" onclick="showBoxModal('boxC')">📦 Box C (Universal)</span></td><td class="muted">Single box used. Arduino is built inside Box C.</td></tr>
            <tr><td><b>Class 7</b></td><td>Smart IoT & Sensors</td><td><span class="box-badge green" onclick="showBoxModal('boxC')">📦 Box C (Universal)</span></td><td class="muted">Single box used.</td></tr>
            <tr><td><b>Class 8</b></td><td>Precision Robotics</td><td><span class="box-badge green" onclick="showBoxModal('boxC')">📦 Box C (Universal)</span></td><td class="muted">Single box used. Motors & Drivers are inside Box C.</td></tr>
            <tr><td><b>Class 9</b></td><td>Python & IoT</td><td><span class="box-badge green" onclick="showBoxModal('boxC')">📦 Box C (Universal)</span></td><td class="muted">Single box used.</td></tr>
            <tr><td><b>Class 10</b></td><td>Edge AI & Vision</td><td><span class="box-badge green" onclick="showBoxModal('boxC')">📦 Box C (Universal)</span></td><td class="muted">Single box used.</td></tr>
            <tr><td><b>Class 11</b></td><td>Drones</td><td><span class="box-badge red" onclick="showBoxModal('boxD')">📦 Box D</span></td><td class="muted">Standard setup.</td></tr>
          </tbody>
        </table>
      </div>
    </div>
